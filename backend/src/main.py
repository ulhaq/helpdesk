...
app.include_router(tickets.router, tags=["Tickets"], prefix="/v1")
app.include_router(contacts.router, tags=["Contacts"], prefix="/v1")
...
app.include_router(
    support_site.router, tags=["Support Site"], prefix="/v1", include_in_schema=False
)
app.include_router(
...
app.include_router(
    help_center.router, tags=["Help Center"], prefix="/v1", include_in_schema=False
)
