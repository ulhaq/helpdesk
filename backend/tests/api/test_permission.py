...
@pytest.mark.parametrize(
    ...
    [
        ...
        # read:audit_log, read:ticket, read:contact, read:report
        (["id"], [[15]], ["gt"], 9),  # ids 16-24
        (["id"], [[10]], ["gte"], 15),  # ids 10-24
